...
if __name__ == '__main__':
    ...
    if not load_params_gen:
        ...
        # save params   
        saver.save(sess, './checkpoints/mnist_gen.ckpt')
    ...
    if not load_params_z:
        ...
        # save params   
        saver.save(sess, './checkpoints/z_classifier.ckpt') 
    else:
        ckpt_file = "./checkpoints/z_classifier.ckpt"
        print('restoring generator from ', ckpt_file)
        saver.restore(sess, ckpt_file) 
    ...
    ####################### Sample from Z space digit-conditionally #######################
    # Parameters
    num_steps=10000
    sample_size = 1
    eps1 = 1e-3
    ...
    for dgt in range(10):
        ...
        for t in range(num_steps):
            ...
            if t % 100 == 0:
                ...
                print("step %d, cross entropy %g"%(t, cross_entropy))
